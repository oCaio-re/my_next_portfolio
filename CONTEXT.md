...
- **Project Showcase**: Carrossel interativo 3D estilo Apple Dock / Fish-Eye. O projeto central fica em destaque com moldura circular maior (`scale-110`, borda iluminada), enquanto os laterais sofrem distorção de curvatura/perspectiva (`rotateY`, `scale-75`, compressão X).
